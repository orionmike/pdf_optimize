...
from libs.file import get_count_files
from libs.pdf import get_file_list_recursive
...
def pdf_optimize() -> None:
    ...
    try:
        ...
        count_file_start = get_count_files(path_files)
        ...
        if count_file_start > 0:
            ...
            time.sleep(10)
            count_file_check = get_count_files(path_files)

            if count_file_start == count_file_check:
                get_file_list_recursive()(path_files)
            else:
